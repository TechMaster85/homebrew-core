...
class PortableRuby < PortableFormula
  ...
  resource "bootsnap" do
    url "https://rubygems.org/downloads/bootsnap-1.20.1.gem"
    sha256 "7ad62cda65c5157bcca0acfcc0ee11fcbb83d7d7a8a72d52ccd85e6ffc130b93"
  ...
  def install
    ...
    make_args = []
    make_args << "BUILTIN_BINARY=yes" if OS.mac? && CROSS_COMPILING
